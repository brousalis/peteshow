...
module.exports = {
  fillOutForms: function() {
    return console.log('PeteshowController::fillOutForms');
  },
  fillOutFormsAndSubmit: function() {
    return console.log('PeteshowController::fillOutFormsAndSubmit');
  },
  randomDate: function() {
    return console.log('PeteshowController::randomDate');
  },
  randomEmail: function() {
    return console.log('PeteshowController::randomEmail');
  },
  randomLetters: function(n) {
    if (n == null) {
      n = 8;
    }
    return console.log('PeteshowController::randomLetters');
  },
  randomNumber: function(n) {
    if (n == null) {
      n = 8;
    }
    return console.log('PeteshowController::randomNumber');
  },
  randomPhoneNumber: function() {
    return console.log('PeteshowController::randomPhoneNumber');
  },
  randomPhoneNumberFormat: function() {
    return console.log('PeteshowController::randomPhoneNumberFormat');
  },
  randomName: {
    firstName: function() {
      return console.log('PeteshowController::randomName:firstName');
    },
    lastName: function() {
      return console.log('PeteshowController::randomName:lastName');
    },
    companyName: function() {
      return console.log('PeteshowController::randomName:companyName');
    },
    catchPhrase: function() {
      return console.log('PeteshowController::randomName:catchPhrase');
    }
  },
  randomAddress: {
    streetName: function() {
      return console.log('PeteshowController::randomAddress:streetName');
    },
    secondary: function() {
      return console.log('PeteshowController::randomAddress:secondary');
    },
    city: function() {
      return console.log('PeteshowController::randomAddress:city');
    },
    zipCodeFormat: function(n) {
      if (n == null) {
        n = 5;
      }
      return console.log('PeteshowController::randomAddress:zipCodeFormat');
    },
    region: function() {
      return console.log('PeteshowController::randomAddress:region');
    }
  },
  randomCatchPhrase: function() {
    return console.log('PeteshowController::randomCatchPhrase');
  },
  randomSentence: function(n) {
    if (n == null) {
      n = 5;
    }
    return console.log('PeteshowController::randomSentence');
  }
};
...
},{"./peteshow-controller":11}],13:[function(require,module,exports){
var store;
